...
imagen.scene.append(AABB((-3, 1, -30), 2, ladrillo))
imagen.scene.append(AABB((-1, 1, -30), 2, ladrillo))
imagen.scene.append(AABB((1, -3, -30), 2, puerta))
imagen.scene.append(AABB((1, -1, -30), 2, puerta))
imagen.scene.append(AABB((-1, -3, -30), 2, puerta))
imagen.scene.append(AABB((-1, -1, -30), 2, puerta))
# #torre 1
...
imagen.scene.append(AABB((9.2, 6.5, -30), 1, ladrillo))
...
imagen.scene.append(AABB((7.6, 6.5, -30), 1, ladrillo))
#torre 2
imagen.scene.append(AABB((-9, -3, -30), 2, ladrillo))
imagen.scene.append(AABB((-9, -1, -30), 2, ladrillo))
imagen.scene.append(AABB((-9, 1, -30), 2, ladrillo))
